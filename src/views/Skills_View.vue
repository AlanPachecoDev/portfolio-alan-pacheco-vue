  ...
  <div class="bigContainer_Skills">
    <div class="leftSide">
      ...
      <div class="leftSide_Right">
        ...
        <div class="leftSide_Down">
          <input class="button" id="leftButton" type="button" value="SKILLS" />
          <input class="button" type="button" value="TOOLS" />
        </div>
      </div>
    </div>
    <div class="rightSide">
        <GridComponent :items="skills" ></GridComponent>
    </div>
  </div>
</template>
